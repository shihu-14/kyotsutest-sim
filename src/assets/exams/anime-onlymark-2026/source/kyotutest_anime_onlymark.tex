...
\begin{tikzpicture}[scale=0.45]
    ...
    % img2（img1 の真下に配置）
    \node[anchor=north west] (img2) at ([xshift=-0.3em, yshift=-1.3cm] img1.south west) {\includegraphics[width=12.8em]{sidonia2.png}};
    % ラベル II
...
\begin{center}
    ...
    \makebox[\textwidth]{
        ...
        \begin{tabularx}{\textwidth}{| X X |}
            \hline
            \iibf{1} おねがい☆ティーチャー  & \iibf{2} オーバーロード \\
            \iibf{3} オッドタクシー & \iibf{4} \,【推しの子】\\
            \hline
        \end{tabularx}
    }
\end{center}
...
\begin{adjustwidth}{1em}{0em} 
    ...
    \vspace{1.3em}
    \begin{tabularx}{\textwidth}{X X X}  % 3列を均等にする
        \iibf{1} イマニティ  & \iibf{2} フリユーゲル  & \iibf{3} ファンタズマ
    \end{tabularx}
    \\
    \vspace{1.5em}
    ...
    \vspace{1.3em}
    \begin{tabularx}{\textwidth}{X X X}  % 3列を均等にする
        \iibf{1} ラファエル  & \iibf{2} メタトロン  & \iibf{3} ガブリエル
    \end{tabularx}
    \\
    \vspace{1.5em}
...
\begin{figure}[htbp]
    ...
    \begin{adjustbox}{scale=0.76, center}
        \subfloat[]{
            \begin{tikzpicture}
                \node[anchor=north west] (img) at (0,0) {\includegraphics[scale=0.28]{akusera.png}};
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{I}};
            \end{tikzpicture}
        }
        \subfloat[]{
            \begin{tikzpicture}
                \node[anchor=north west] (img) at (0,0) {\includegraphics[scale=0.3]{yotuba3.png}};
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{II}};
            \end{tikzpicture}
        }
        \subfloat[]{
            \begin{tikzpicture}
                \node[anchor=north west] (img) at (0,0) {\includegraphics[scale=0.19]{sinomiya.png}};
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{III}};
            \end{tikzpicture}
        }
        \subfloat[]{
            \begin{tikzpicture}
                \node[anchor=north west] (img) at (0,0) {\includegraphics[scale=0.21]{nanakusa.png}};
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{IV}};
            \end{tikzpicture}
        }
        \subfloat[]{
            \begin{tikzpicture}
                \node[anchor=north west] (img) at (0,0) {\includegraphics[scale=0.21]{yanami.png}};
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{V}};
            \end{tikzpicture}
        }
        \subfloat[]{
            \begin{tikzpicture}
                \node[anchor=north west] (img) at (0,0) {\includegraphics[scale=0.35]{titanda.png}};
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{VI}};
            \end{tikzpicture}
        }
    \end{adjustbox}
\end{figure}
    ...
    \begin{adjustbox}{scale=0.72, center}
        \subfloat[]{
            \begin{tikzpicture}
                ...
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{A}};
            \end{tikzpicture}
        }
        \hspace{1.5em}
        \subfloat[]{
            \begin{tikzpicture}
                ...
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{B}};
            \end{tikzpicture}
        }
        \hspace{1.5em}
        \subfloat[]{
            \begin{tikzpicture}
                ...
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{C}};
            \end{tikzpicture}
        }
        \hspace{1.5em}
        \subfloat[]{
            \begin{tikzpicture}
                ...
                \node[anchor=north west, xshift=-2pt, yshift=10pt] at (img.north west) {\textbf{D}};
            \end{tikzpicture}
        }
    \end{adjustbox}
\end{figure}
...
\begin{adjustwidth}{1em}{0em} 
    ...
    \begin{tabularx}{\textwidth}{X X X X}  % 3列を均等にする
        \iibf{1} isekai  & \iibf{2} romcom & \iibf{3} yuri & \iibf{4} catgirl\\
    \end{tabularx}
    \\
    \vspace{1.8em}
    \noindent\textbf{問\hspace{0.5em}2} \hspace{0.5em} \counterbox \\ [1.0em]
    ...
    \vspace{1.1em}
    \begin{tabularx}{\textwidth}{X X X X}  % 3列を均等にする
        \iibf{1} manga  & \iibf{2} lightnovel  & \iibf{3} comiket & \iibf{4} doujinshi\\
    \end{tabularx}
    \\
\end{adjustwidth} 
\clearpage 
...
\begin{tabularx}{\textwidth}{X X X l}  % 3列を均等にする
    \iibf{1}\;scoff & \iibf{2}\;despise  & \iibf{3}\;inferior & \iibf{4}\; underestimate
\end{tabularx}
