...
import type { QuestionSlot } from "./exam";
import { answersEqual, gradeExam, gradeQuestion, toggleAnswer } from "./exam";
import { animeOnlymarkExam } from "../data/exams/anime-onlymark-2026/exam";
