...
import eraserImageUrl from "./assets/eraser.png";
import pencilImageUrl from "./assets/pencil.png";
...
describe("HomeDrawingTools", () => {
  ...
  it("keeps the cropped PNG files at their exact source dimensions", () => {
    expect(pngDimensions("src/features/home/drawing/assets/pencil.png")).toEqual({ width: 289, height: 606 });
    expect(pngDimensions("src/features/home/drawing/assets/eraser.png")).toEqual({ width: 181, height: 230 });
  });
});
